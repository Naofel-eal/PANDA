---
name: nud-report-progress
description: Send a non-terminal PROGRESS_REPORTED callback to the NUD orchestrator when work is advancing and no blocker or terminal outcome applies
