...
class HashSupportTest {
    ...
    @Test
    @DisplayName("Given a ticket fingerprint when PANDA hashes it then a stable SHA-256 identifier is produced")
    void givenTicketFingerprint_whenPANDAHashesIt_thenStableSha256IdentifierIsProduced() {
