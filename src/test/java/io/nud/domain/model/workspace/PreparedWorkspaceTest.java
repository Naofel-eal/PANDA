...
class PreparedWorkspaceTest {
    ...
    @Test
    @DisplayName("Given repository workspaces when the prepared workspace is created then NUD keeps an immutable copy of the repository list")
    void givenRepositoryWorkspaces_whenThePreparedWorkspaceIsCreated_thenNUDKeepsAnImmutableCopyOfTheRepositoryList() {
    ...
    @Test
    @DisplayName("Given no repository workspace when the prepared workspace is created then NUD exposes an empty repository list")
    void givenNoRepositoryWorkspace_whenThePreparedWorkspaceIsCreated_thenNUDExposesAnEmptyRepositoryList() {
