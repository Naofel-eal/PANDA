...
class HashSupportTest {
    ...
    @Test
    @DisplayName("Given a ticket fingerprint when DevFlow hashes it then a stable SHA-256 identifier is produced")
    void givenTicketFingerprint_whenDevFlowHashesIt_thenStableSha256IdentifierIsProduced() {
